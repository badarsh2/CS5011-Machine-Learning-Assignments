...
def main():
   ...
   train_set = c_[train_x, train_y]
   test_set = c_[test_x, test_y]
   data_set = r_[train_set, test_set]
   ...
   plot(data_set[:,:-1], extract_features_lda(model_lda, data_set[:,:-1]), data_set[:, -1], model, "Plot result")
